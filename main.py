import pygame
import random
from sudokuGenerator import generisi_sudoku
from sudokuSolver import provera_resenja_sudoku, validan_potez
...
def main():
    ...
    def reset_board():
        nonlocal board, zakljucane_celije, selektovana_celija
    ...
    while igra:
        ...
        if message:
            message_text = button_font.render(message, True, TEXT_COLOR)
            screen.blit(message_text, (20, GRID_SIZE + 60))
